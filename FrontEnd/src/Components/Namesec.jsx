...
useEffect(()=>{
    ...
    const submitHandler = (e)=>{
      ...
      const validation = validator();
        if(validation){
          ...
          navigate(`/chat/mainform`, {state:name})
        }
  ...
  return (
    ...
    <div className='formcontainer'>
       ...
       <div>
                <h2 className='welcometxt'>Welcome to <span style={{color:"rgb(120, 2, 255)",fontWeight:"bold"}}>tempChat</span></h2>
        </div>
        <form onSubmit={submitHandler}>
        <div >
                <input type='text' className=' name' name='name'  placeholder='Enter a unique name' onChange={Handlechange}/>
        </div>
